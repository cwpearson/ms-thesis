...
\begin{figure}[ht]
    ...
    \\
    \begin{subfigure}[b]{0.45\textwidth}
        \includegraphics[width=\textwidth]{figures/generated/minsky_pinned_affinity.pdf}
        \caption{}
...
\begin{table}[ht]
    ...
    \hline
    \textbf{Transfer Kind}                         & \textbf{Minsky}     & \textbf{AC922} & \textbf{DGX-1} \\ \hline 
    Pageable $\leftrightarrow$ GPU (local)         & \checkmark     & \checkmark & \\ \hline
    Pageable $\leftrightarrow$ GPU (remote)        & \checkmark     & \checkmark & \\ \hline
    Pinned $\leftrightarrow$ GPU (local)           & depends on CPU & $\times$   & \\ \hline
    Pinned $\leftrightarrow$ GPU (remote)          & depends on CPU & \checkmark & \\ \hline
    \end{tabular}
\end{table}
