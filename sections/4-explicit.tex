...
Figure~\ref{fig:cpu0-cpu1} shows the performance achieved by the \texttt{rd\_8} and \texttt{wr\_8} workloads.
...
\begin{figure}[H]
	\centering
	\includegraphics[width=\textwidth]{figures/generated/host_to_pinned.pdf}
