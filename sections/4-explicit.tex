...
Algorithm~\ref{alg:explicit} is used to evaluate the achievable transfer bandwidth between device allocations, with \texttt{cudaDeviceDisablePeerAccess} or \texttt{cudaDeviceEnablePeerAccess}.
First, peer access is enabled or disabled depending on the desired experiment.
