...
Their key differences are in CPU architecture (64-lit little-endian PowerPC for ``Minsky'', x86-64 for DGX-1), number of GPUs (4 vs 8), and GPU connection topology (bonded NVLink vs hybrid PCIe/NVLink).

\todo{Discuss NUMA arch for each system}
...
\begin{table}[]
	...
	Interconnect  & NVLink 1.0                                      \\ \hline
    \end{tabular}
\end{table}

The IBM S822LC ``Minsky'' machine features two POWER8 CPUs and four NVIDIA P100 GPUs\cite{caldeira2016s822lc}.
Each POWER8 s has 10 cores, with 8-way simultaneous multithreading, and is attached to 256GB of DDR4 memory. for a total of 160 threads and 512 GB of memory.
...
\begin{figure}
    \centering
	\includegraphics[width=0.5\textwidth]{figures/generated/minsky-hardware.pdf}
...
\begin{figure}
    \centering
	\includegraphics[width=0.5\textwidth]{figures/generated/dgx1-hardware.pdf}
...
\begin{table}[]
	...
	Interconnect  & NVLink 2.0                                      \\ \hline
    \end{tabular}
\end{table}

\begin{figure}
    \centering
	\includegraphics[width=0.5\textwidth]{figures/generated/hal-hardware.pdf}
