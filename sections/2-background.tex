...
Physically, each PCIe 3.0 lane has four wires, divided into two differential signaling pairs.
Each pair operates at 8 Gb/s.
...
\begin{table}[ht]
	...
	\begin{tabular}{cccc}
		\hline
		\textbf{PCIe Revision} & \textbf{Signaling Rate}   & \textbf{Encoding} & \textbf{Bandwidth} \\ \hline
		\textbf{1.0}           &                           &                   & Tree                  \\ \hline
		\textbf{2.0}           &                           &                   & Point-to-Point        \\ \hline
		\textbf{3.0}           &                           &                   & Point-to-Point        \\ \hline
	\end{tabular}
\end{table}
...
Table~\ref{tab:dgx1} and Figure \ref{fig:topo-dgx-simple} summarizes the hardware configuration.
