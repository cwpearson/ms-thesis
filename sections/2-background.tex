...
A summarry of unified memory APIs are shown in Table~\ref{tab:cuda-um-apis}
...
In principle, unified memory allocations are automatically migrated toward their most recent use.
