...
\begin{figure}
    ...
    \begin{tikzpicture}[
        ...
        \node [above] at (1, \ra+0.25\rt) {IEEE 754};

        \shade[left color=black, right color=white] (0,\rb) rectangle (2,\rb+\rt);
        \node [above] at (3, \rb+0.25\rt) {SIMD extensions};

        \draw[fill=gray] (3,\ra) rectangle (10,\ra+\rt) node[pos=0.5] {DPSs};

        \draw[fill=gray] (5,\rb) rectangle (10,\rb+\rt) node[pos=0.5] {GPUs};

        \draw[fill=gray] (7,\rc) rectangle (10,\rc+\rt) node[pos=0.5] {FPGAs};
