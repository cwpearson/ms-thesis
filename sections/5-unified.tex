...
\begin{table}[h]
	...
	\begin{tabular}{|c|c|c|c|}
		\hline
		\textbf{Page Fault}              & \textbf{S822LC Latency} & \textbf{AC922 Latency} & \textbf{DGX-1 Latency} \\ \hline
		CPU  $\leftarrow$  GPU  (local)  & 17.9                    & 24.4                   &  32.2 \\ \hline
		CPU  $\rightarrow$ GPU  (local)  & 15.2                    & 23.6                   &  26.6 \\ \hline
		GPU0 $\leftarrow$  GPU1 (local)  & 26.9                    & 35.9                   &  37.1 \\ \hline
		GPU0 $\rightarrow$ GPU2 (remote) & 35.6                    & 38.5                   &  50.3\\ \hline
	\end{tabular}
\end{table}
