...
Although \todo{hwcomm-apptracer} can record pointer kernel arguments, that does not provide information about the size of the data transfer, only the source and destination of that data.
