...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.5\textwidth]{figures/app-abstraction.pdf}
...
\begin{figure}[ht]
    ...
    \begin{subfigure}[b]{0.3\textwidth}
        \includegraphics[width=\textwidth]{figures/minsky-topo-hardware.pdf}
        \caption{Minky Hardware Topology. Comonents have different distances and link bandwidths.}
        \label{fig:minsky-topo-hardware}
    \end{subfigure}
    ~
    \begin{subfigure}[b]{0.3\textwidth}
        \includegraphics[width=\textwidth]{figures/minsky-topo-cuda-simple.pdf}
    ...
    ~
    \begin{subfigure}[b]{0.3\textwidth}
        \includegraphics[width=\textwidth]{figures/minsky-topo-cuda-detail.pdf}
...
The third item on the list is covered in Section~\ref{sec:app-char}.
