...
\section{Hardware Topology vs. Logical Topology}

Consider the IBM ``Minsky'' machine shown in Figure~\ref{fig:minsky-actual-logical}.

\begin{figure}[ht]
    \centering
    \begin{subfigure}[b]{0.3\textwidth}
        \includegraphics[width=\textwidth]{figures/minsky-topo-actual.pdf}
        \caption{Actual Minsky Topology}
        \label{fig:gull}
    \end{subfigure}
    ~
    \begin{subfigure}[b]{0.3\textwidth}
        \includegraphics[width=\textwidth]{figures/minsky-topo-logical.pdf}
        \caption{Logical Minsky Topology}
        \label{fig:gull}
    \end{subfigure}

    \caption[\todo{short}]{\todo{long}}
    \label{fig:minsky-actual-logical}
\end{figure}
...
\subsection{CPU Mapped allocation to GPU with with direct access}
...
\subsection{Dual-Socket Power8 and NVIDIA Pascal P100 ``Minsky''}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.5\textwidth,draft]{figures/minsky_um-bw_cpu0-gpu0.png}
    \caption[\todo{short}]{\todo{long}}
    \label{fig:}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.5\textwidth,draft]{figures/minsky_um-bw_gpu0-cpu0.png}
    \caption[\todo{short}]{\todo{long}}
    \label{fig:}
\end{figure}
