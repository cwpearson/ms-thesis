...
For example, consider the IBM ``Minsky'' machine, shown in Figure~\ref{fig:topo-minsky-example}.

\begin{figure}[ht]
    \centering
    \includegraphics[width=0.5\textwidth,draft]{figures/topo-minsky-example.png}
    \caption[\todo{short}]{\todo{long}}
    \label{fig:topo-minsky-example}
\end{figure}
